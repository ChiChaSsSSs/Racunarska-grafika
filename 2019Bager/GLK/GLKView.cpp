...
void CGLKView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	if (nChar == VK_LEFT)
		...
		m_glRenderer.xRotation += 10;
	else if (nChar == VK_DOWN)
		m_glRenderer.xRotation -= 10;
	else if (nChar == 'P')
	{
		if (m_glRenderer.zoom < -8)
			m_glRenderer.zoom += 2;
	}
	else if (nChar == 'O')
	{
		if (m_glRenderer.zoom > -50)
			m_glRenderer.zoom -= 2;
	}
	else if (nChar == '1')
		m_glRenderer.bodyRotation += 10;
	else if (nChar == '2')
		m_glRenderer.bodyRotation -= 10;
	else if (nChar == '3')
		m_glRenderer.firstForkRotation += 10;
	else if (nChar == '4')
		m_glRenderer.firstForkRotation -= 10;
	else if (nChar == '5')
		m_glRenderer.secondArmRotation += 10;
	else if (nChar == '6')
		m_glRenderer.secondArmRotation -= 10;
	else if (nChar == '7')
		m_glRenderer.forkRotation += 10;
	else if (nChar == '8')
		m_glRenderer.forkRotation -= 10;
